...
words = [brown.words(categories='lore'), brown.words(categories='learned'), brown.words(categories='humor')]
sents = [brown.sents(categories='lore'), brown.sents(categories='learned'), brown.sents(categories='humor')]
